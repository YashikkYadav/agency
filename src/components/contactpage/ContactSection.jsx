          ...
          <div className="d-flex flex-column gap-5">
            <div className="d-flex flex-xl-row flex-column justify-content-between">
              ...
              <p className="align-self-end scrollanimation animated fadeInDown adr-9 adl-1">
                Have questions or need expert digital marketing & creative{" "}
                <br /> solutions? Our team is ready to assist you.
              </p>
              <div
                className="sub-heading text-accent second position-absolute"
                style={{ zIndex: -1, top: 0, right: "10%" }}
              >
                CONTACT US
              </div>
            </div>
            <div className="row row-cols-lg-4 row-cols-1">
              <div className="col mb-3">
                <div className="card-service gap-5 mw-100 h-100">
                  ...
                  <div className="d-flex flex-column align-items-center gap-3">
                    <i
                      className="rtmicon rtmicon-location"
                      style={{ fontSize: "20px" }}
                    ></i>
                    <p className="m-0">
              ...
              <div className="col mb-3">
                <div className="card-service gap-5 mw-100 h-100">
                  ...
                  <div className="d-flex flex-column align-items-center gap-3">
                    <i
                      className="rtmicon rtmicon-envelope"
                      style={{ fontSize: "20px" }}
                    ></i>
                    <p className="m-0">info@yashikyadavanco.com</p>
                  </div>
                </div>
              </div>
              <div className="col mb-3">
                <div className="card-service gap-5 mw-100 h-100">
                  ...
                  <div className="d-flex flex-column align-items-center gap-3">
                    <i
                      className="rtmicon rtmicon-classic-phone"
                      style={{ fontSize: "20px" }}
                    ></i>
                    <p className="m-0">+91 9887007362</p>
                  </div>
                </div>
              </div>
              <div className="col mb-3">
                <div className="card-service gap-5 mw-100 h-100">
                  ...
                  <div className="d-flex flex-column align-items-center gap-3">
                    <i
                      className="rtmicon rtmicon-globe"
                      style={{ fontSize: "20px" }}
                    ></i>
                    <p className="m-0">www.yashikyadavandco.com</p>
                  </div>
                </div>
              </div>
            </div>
            <div className="row row-cols-lg-2 row-cols-1 position-relative">
                  ...
                  >
                    <div className="d-flex p-2">
                      ...
                      <button
                        ...
                        aria-label="Close"
                      >
                        <i className="rtmicon rtmicon-times"></i>
                      </button>
                    </div>
                  </div>
                  <div
              ...
              <img
                ...
                alt="Yashik Yadav and Co contact section decoration"
