...
const WhyChooseUsSection = () => {
  return (
    <div className="section">
      <div className="mx-auto align-items-center position-relative bg-color-2 p-xl-5 p-3 rounded-5"
        style={{ maxWidth: '1770px' }}>
        <div className="sub-heading position-absolute text-accent" style={{ zIndex: 1, left: '2%', top: '-1%' }}>
          WHY CHOOSE US
        </div>
        <div className="d-flex flex-column gap-5">
          <div className="d-flex flex-row align-items-center justify-content-end gap-2 position-relative"
            style={{ zIndex: 2 }}>
          ...
          <p className="fw-bold scrollanimation animated fadeInDown adr-9 adl-2">
            We're more than just a service—we're your <br /> growth partner. With our expertise, tailored <br />
            strategies.
          </p>
          <div className="row row-cols-xl-2 row-cols-1">
            <div className="col position-relative mb-3" style={{ minHeight: '500px' }}>
              <img className="img-fluid ms-xl-5" src="/image/img 14.png" alt="Team working on digital marketing strategies"
        ...
        `}
              ...
              <img className="img-fluid float-img middimage" src="/image/img 15.png" alt="Creative brainstorming session"
                style={{ aspectRatio: '3/2', width: '384px' }} />
             
              <button className="btn-play choose-us" type="button" data-bs-toggle="modal"
                data-bs-target="#e119">
            ...
            <div className="col mb-3">
              <div className="d-flex flex-column" style={{ gap: '7rem' }}>
                <div className="d-flex flex-column gap-4">
                  <img className="img-fluid ms-auto" src="/image/icon 3.png" alt="Decorative icon representing expertise" width="174px" />
                  <div className="r-progress w-100" style={{ "--value": 93 }}>
                    <span className="font-1 fw-semibold">Expert Strategies</span>
                  ...
                  <div className="r-progress w-100" style={{ "--value": 98 }}>
                    <span className="font-1 fw-semibold">Dedicated Support</span>
                    <div className="progress-container mt-2">
                      <div className="r-progress-bar percentage-label">
                        <div className="progress-value"></div>
                      </div>
                ...
                <img className="img-fluid mx-auto" src="/image/icon 4.png" alt="Decorative icon representing results" width="369px" />
              </div>
            </div>
          </div>
          <div className="row row-cols-xl-3 row-cols-1">
            <div className="col mb-3">
              <div className="d-flex flex-column align-items-center">
                <div className="text-center">
                  <span className="sub-heading number" data-target="20" data-duration="1000">0</span>
            ...
            <div className="col mb-3">
              <div className="d-flex flex-column align-items-center">
                <div className="text-center">
                <span className="sub-heading text-center number" data-target="5"
                  data-duration="1000">0</span><span className="sub-heading">+</span>
                  </div>
            ...
            <div className="col mb-3">
              <div className="d-flex flex-column align-items-center">
                 <div className="text-center">
                <span className="sub-heading text-center number" data-target="120"
