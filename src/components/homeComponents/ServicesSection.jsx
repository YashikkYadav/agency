  ...
  return (
    <div className="section position-relative home-section">
      <div className="r-container">
        <div className="sub-heading position-absolute text-accent second home-subheading" style={{ zIndex: -1, left: '12%', top: '-2%' }}>
          OUR SERVICES
        </div>
        <div className="d-flex flex-column gap-3">
          ...
          <div className="row row-cols-xl-2 row-cols-1 align-items-center">
            <div className="col col-lg-8 mb-3 home-service-image" style={{height: '160px', overflow: 'hidden', backgroundSize: 'cover', borderRadius: '10px'}}>
              <img className="img-fluid" src="/image/3.jpg" alt="how we work" width="260px" style={{borderRadius: '10px', overflow: 'hidden', height: '100%', objectFit: 'cover'}} />
            </div>
            <div className="col col-lg-4 mb-3">
              <p className="text-lg-end scrollanimation animated fadeInDown adr-9 adl-2">
                We provide digital marketing and social media services to <br /> help your business stand
                out, attract the right audience.
              </p>
            </div>
          </div>
          ...
          <div className="d-flex flex-column mt-3">
            <div className="navigation">
              <h4>Branding</h4>
              <img src="/image/4.png" className="img-fluid home-portfolio-image" alt="brnading image" />
              <Link to="/about-us">
            ...
            <div className="navigation">
              <h4>Marketing</h4>
              <img src="/image/5.png" className="img-fluid home-portfolio-image" alt="marketing image" />
              <Link to="/about-us">
                <i className="rtmicon rtmicon-arrow-up-right fw-bold"></i>
              </Link>
            </div>
            ...
            <div className="navigation">
              <h4>Development</h4>
              <img src="/image/6.png" className="img-fluid home-portfolio-image" alt="Development image" />
              <Link to="/about-us">
                <i className="rtmicon rtmicon-arrow-up-right fw-bold"></i>
              </Link>
            </div>
            ...
            {/* <div className="navigation">
              ...
              <img src="/image/dummy-img-1024x1024.jpg" className="img-fluid" alt="Performance analytics service illustration" />
              <Link to="/about-us">
                <i className="rtmicon rtmicon-arrow-up-right fw-bold"></i>
              </Link>
            </div>
            ...
            <div className="navigation">
              ...
              <img src="/image/dummy-img-1024x1024.jpg" className="img-fluid" alt="Multi-platform management service illustration" />
              <Link to="/about-us">
                <i className="rtmicon rtmicon-arrow-up-right fw-bold"></i>
              </Link>
            </div> */ }
