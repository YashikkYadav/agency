    ...
    <>
      <div className="section position-relative">
        <div className="r-container">
          <div
            className="sub-heading position-absolute text-accent second"
          ...
          <div className="d-flex flex-column gap-5">
            <div className="d-flex flex-row align-items-center gap-2">
              ...
              <h3 className="scrollanimation animated fadeInDown adr-9">
                Why Us ?<br />
                Marketing Agency for Your Growth
              </h3>
            </div>
                ...
                <div className="d-flex flex-column gap-5">
                  <div className="d-flex flex-column gap-3">
                    <p
                      ...
                      style={{ maxWidth: "65%" }}
                    >
                      We craft full-funnel digital marketing strategies that
                      blend creativity, data, and automation to deliver
                      measurable growth. From brand storytelling and performance
                      marketing to CRM and lead nurturing - we help businesses
                      scale smarter, faster, and stronger across markets
                    </p>
                    <div className="d-flex flex-row align-items-center gap-3">
                      ...
                      <Link
                        to="/about-us"
                        className="accent-color text-decoration-underline"
                      >
