...
const HeroSection = ({ title, description, icon }) => {
  ...
  const heroTitle = title || "HASHTAG & TREND RESEARCH";
  const heroDescription = description || "MAXIMIZE YOUR REACH POTENTIAL";
  const heroIcon = icon || "rtmicon rtmicon-lightbulb";
