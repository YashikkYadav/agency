...
const Blog = () => {
  return (
    <div>
      <Helmet>
        <link rel="canonical" href="https://yashikyadavandco.com/blog" />
      </Helmet>
      {/* Hero */}
      <div className="section bg-image-blog pb-0 px-xl-0">
            ...
            <div className="col col-xl-10 mb-3">
              <div className="d-flex flex-column gap-5">
                ...
                <div className="d-flex flex-lg-row flex-column-reverse align-items-center justify-content-xl-between justify-content-center gap-lg-5">
                  <img src="/image/icon 6.png" className="img-fluid" alt="Decorative icon for blog page"
