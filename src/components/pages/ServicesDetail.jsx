        ...
        <div className="section">
          <div className="r-container">
            ...
            >
              ...
              <a href="/services" className="btn btn-accent mt-3">
                View All Services
              </a>
            </div>
          </div>
  ...
  return (
    <div>
      <Helmet>
        ...
        <meta
          name="keywords"
          content={`${serviceDetail.title.toLowerCase()}, ${serviceDetail.category.toLowerCase()}, digital marketing, yashik yadav and co`}
        />
        <meta property="og:title" content={`${serviceDetail.metaTitle}`} />
        <meta
          property="og:description"
          content={serviceDetail.metaDescription}
        />
        <meta property="og:type" content="website" />
        <meta
          property="og:url"
          content={`https://yashikyadavandco.com/services/${serviceId}`}
        />
        <meta
          property="og:image"
          content={
            serviceDetail.image ||
            "https://yashikyadavandco.com/image/servicedetail/default.jpg"
          }
        />
        <meta
          property="og:image:alt"
          content={`Yashik Yadav and Co - ${serviceDetail.title}`}
        />
        ...
        <link
          rel="canonical"
          href={`https://yashikyadavandco.com/services/${serviceId}`}
        />
          ...
          <div className="row row-cols-xl-2 row-cols-1 gap-5">
            <div className="col col-xl-7 mb-3">
              <div className="d-flex flex-column gap-3">
                ...
                <p>{serviceDetail.longDescription}</p>
                ...
                <p className="m-0">
                  ...
                  strategies for your specific needs. Instead of relying on
                  generic approaches, we utilize research-driven techniques to
                ...
                <div className="d-flex flex-row gap-3">
                  <p style={{ maxWidth: "55%" }}>
                    Our service provides comprehensive benefits tailored to your
                    business objectives. We help you leverage optimal
                    opportunities for growth and visibility in your industry.
                  </p>
                ...
                <h5 className="scrollanimation animated fadeInDown adr-9 mt-4">
                  Our Process:
                </h5>
                    ...
                    serviceDetail.relatedServices.map(
                      (relatedService, index) => {
                        ...
                        if (
                          ...
                          const related = serviceDetails.find(
                            (service) => service.title === relatedService
                          );
                          return (
                            <div className="category" key={index}>
                              <i className="rtmicon rtmicon-arrow-up-right"></i>
