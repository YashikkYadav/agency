...
const PortfolioDetailSection = ({ portfolioItem }) => {
  ...
  const relatedProjects = portfolioItems
    ...
    .map(item => ({
      ...
      link: `/portfolio-detail/${item.title.toLowerCase().replace(/\s+/g, '-')}`
    }));
        ...
        <div className="row row-cols-xl-2 row-cols-1 gap-5">
          <div className="col col-xl-7 mb-3">
            <div className="d-flex flex-column gap-3">
              ...
              <h5 className="scrollanimation animated fadeInDown adr-9">Project Overview</h5>
              <p>
                {description}
              </p>
              <h5 className="scrollanimation animated fadeInDown adr-9">Project & Impact</h5>
              <p className="m-0">
                {result}
              </p>
              ...
              <div className="row row-cols-lg-2 row-cols-1">
                <div className="col mb-3">
                  <img src="/image/aboutpage/4.png" className="img-fluid" alt="Key features of project" style={{ aspectRatio: '16/9' }} />
                </div>
                <div className="col mb-3">
                  <div className="d-flex flex-column gap-3">
                    <h5 className="scrollanimation animated fadeInDown adr-9">Key Features</h5>
                    {keyFeatures.map((feature, index) => (
                      <div className="category" key={index}>
                        <i className="rtmicon rtmicon-check accent-color"></i>
                        <Link to="/about-us" className="button text-color">{feature}</Link>
                      </div>
                    ))}
                  </div>
                </div>
              </div>
              <h5 className="scrollanimation animated fadeInDown adr-9">Final Results & Takeaways</h5>
              <p className="m-0">
                The collaboration with {title} showcased the power of data-driven marketing. With a well-structured approach to {service}, the company gained valuable insights that translated into higher audience engagement, increased brand visibility, and more conversions. This project highlights how businesses can maximize their digital potential by making informed, strategic decisions based on real-time data.
              </p>
              <hr className="text-color-2" />
            </div>
            <div className="d-flex flex-row align-items-center justify-content-between">
              ...
              <div className="social-icons row">
                <a href="https://www.facebook.com"><i className="rtmicon rtmicon-social-share"></i></a>
                <a href="https://www.instagram.com"><i className="rtmicon rtmicon-social-advertising"></i></a>
                <a href="https://x.com"><i className="rtmicon rtmicon-social-share"></i></a>
                <a href="https://www.youtube.com"><i className="rtmicon rtmicon-social-advertising"></i></a>
              </div>
            </div>
          </div>
          <div className="col col-xl-4 mb-3">
            <div className="d-flex flex-column gap-5">
              <div className="d-flex flex-column gap-4">
                <h4 className="fw-normal scrollanimation animated fadeInDown adr-9">Related Project</h4>
                {relatedProjects.map((project) => (
                  <div className="category" key={project.id}>
                    <i className="rtmicon rtmicon-arrow-up-right"></i>
                    <Link to={project.link} className="button text-color">{project.title}</Link>
                  </div>
                ))}
              </div>
              <div className="d-flex flex-column gap-4">
                <h4 className="scrollanimation animated fadeInDown adr-9 adl-1">Let's Elevate Your Digital Presence!</h4>
                <p className="scrollanimation animated fadeInDown adr-9 adl-2" style={{ maxWidth: '80%' }}>
                  Looking to boost engagement, traffic, and brand awareness like our previous
                  projects? Our team is ready to work.
                </p>
